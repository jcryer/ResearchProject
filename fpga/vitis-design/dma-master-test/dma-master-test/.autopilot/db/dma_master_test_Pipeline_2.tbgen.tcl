set moduleName dma_master_test_Pipeline_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dma_master_test_Pipeline_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln31 int 62 regular  }
	{ buff float 32 regular {array 103 { 0 3 } 0 1 }  }
	{ buff_1 float 32 regular {array 103 { 0 3 } 0 1 }  }
	{ buff_2 float 32 regular {array 103 { 0 3 } 0 1 }  }
	{ buff_3 float 32 regular {array 103 { 0 3 } 0 1 }  }
	{ buff_4 float 32 regular {array 103 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "arr","offset": { "type": "dynamic","port_name": "arr","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln31", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "buff", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buff_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buff_2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buff_3", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buff_4", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ buff_1_we0 sc_out sc_logic 1 signal 3 } 
	{ buff_1_d0 sc_out sc_lv 32 signal 3 } 
	{ buff_2_address0 sc_out sc_lv 7 signal 4 } 
	{ buff_2_ce0 sc_out sc_logic 1 signal 4 } 
	{ buff_2_we0 sc_out sc_logic 1 signal 4 } 
	{ buff_2_d0 sc_out sc_lv 32 signal 4 } 
	{ buff_3_address0 sc_out sc_lv 7 signal 5 } 
	{ buff_3_ce0 sc_out sc_logic 1 signal 5 } 
	{ buff_3_we0 sc_out sc_logic 1 signal 5 } 
	{ buff_3_d0 sc_out sc_lv 32 signal 5 } 
	{ buff_4_address0 sc_out sc_lv 7 signal 6 } 
	{ buff_4_ce0 sc_out sc_logic 1 signal 6 } 
	{ buff_4_we0 sc_out sc_logic 1 signal 6 } 
	{ buff_4_d0 sc_out sc_lv 32 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buff_1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff_1", "role": "we0" }} , 
 	{ "name": "buff_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff_1", "role": "d0" }} , 
 	...
 	{ "name": "buff_2_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff_2", "role": "we0" }} , 
 	{ "name": "buff_2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff_2", "role": "d0" }} , 
 	...
 	{ "name": "buff_3_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff_3", "role": "we0" }} , 
 	{ "name": "buff_3_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff_3", "role": "d0" }} , 
 	...
 	{ "name": "buff_4_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff_4", "role": "we0" }} , 
 	{ "name": "buff_4_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff_4", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	buff_1 { ap_memory {  { buff_1_address0 mem_address 1 7 }  { buff_1_ce0 mem_ce 1 1 }  { buff_1_we0 mem_we 1 1 }  { buff_1_d0 mem_din 1 32 } } }
	buff_2 { ap_memory {  { buff_2_address0 mem_address 1 7 }  { buff_2_ce0 mem_ce 1 1 }  { buff_2_we0 mem_we 1 1 }  { buff_2_d0 mem_din 1 32 } } }
	buff_3 { ap_memory {  { buff_3_address0 mem_address 1 7 }  { buff_3_ce0 mem_ce 1 1 }  { buff_3_we0 mem_we 1 1 }  { buff_3_d0 mem_din 1 32 } } }
	buff_4 { ap_memory {  { buff_4_address0 mem_address 1 7 }  { buff_4_ce0 mem_ce 1 1 }  { buff_4_we0 mem_we 1 1 }  { buff_4_d0 mem_din 1 32 } } }
}
