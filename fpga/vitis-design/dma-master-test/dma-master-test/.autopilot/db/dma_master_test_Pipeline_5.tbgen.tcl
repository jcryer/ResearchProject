set moduleName dma_master_test_Pipeline_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dma_master_test_Pipeline_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ sext_ln31 int 62 regular  }
	{ buff float 32 regular {array 103 { 1 3 } 1 1 }  }
	{ buff_1 float 32 regular {array 103 { 1 3 } 1 1 }  }
	{ buff_2 float 32 regular {array 103 { 1 3 } 1 1 }  }
	{ buff_3 float 32 regular {array 103 { 1 3 } 1 1 }  }
	{ buff_4 float 32 regular {array 103 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "arr","offset": { "type": "dynamic","port_name": "arr","bundle": "control"},"direction": "READWRITE"}]}]} , 
...
set portList { 
	...
	{ buff_4_q0 sc_in sc_lv 32 signal 6 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_53_32_1_1_U119", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	buff { ap_memory {  { buff_address0 mem_address 1 7 }  { buff_ce0 mem_ce 1 1 }  { buff_q0 in_data 0 32 } } }
	buff_1 { ap_memory {  { buff_1_address0 mem_address 1 7 }  { buff_1_ce0 mem_ce 1 1 }  { buff_1_q0 in_data 0 32 } } }
	buff_2 { ap_memory {  { buff_2_address0 mem_address 1 7 }  { buff_2_ce0 mem_ce 1 1 }  { buff_2_q0 in_data 0 32 } } }
	buff_3 { ap_memory {  { buff_3_address0 mem_address 1 7 }  { buff_3_ce0 mem_ce 1 1 }  { buff_3_q0 in_data 0 32 } } }
	buff_4 { ap_memory {  { buff_4_address0 mem_address 1 7 }  { buff_4_ce0 mem_ce 1 1 }  { buff_4_q0 in_data 0 32 } } }
}
